...
class BinaryDiagnostic {
    ...
    static void main(String[] args) {
        println "Day3 power consumption rating: ${calculatePowerConsumption(new File("src/main/resources/day3/input.txt").readLines())}"
        println "Day3 life support rating: ${calculateLifeSupportRating(new File("src/main/resources/day3/input.txt").readLines())}"
    }
