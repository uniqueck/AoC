...
class SevenSegmentSearch {
    ...
    static void main(String[] args) {
        println "SevenSegmentSearch star1: ${star1(new File("src/main/resources/day8/input.txt"))}"
        println "SevenSegmentSearch star2: ${star2(new File("src/main/resources/day8/input.txt"))}"
    }
